//Source: https://github.com/paulhoux/Cinder-Samples/tree/master/GeometryShader
...
void main(void)
{
  ...
  // Determine the length of the miter by projecting it onto normal and then inversing it
